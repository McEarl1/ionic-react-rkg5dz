              ...
              <IonList id="developers">
                <IonItem>
                  <IonThumbnail slot="start">
                    <img
                      ...
                      src="/assets/images/MikhailMendozaPic.png"
                    />
                  </IonThumbnail>
                  <IonLabel>
                    <b>FOUNDER:</b> Mikhail Pitstock Mendoza
                  </IonLabel>
                </IonItem>
                <br />
                <IonItem>
                ...
                <IonItem>
                  <IonThumbnail slot="start">
                    <img
                      alt="Silhouette of mountains"
                      src="/assets/images/JamaicaBermudezPic.png"
                    />
                  </IonThumbnail>
                ...
                <IonItem>
                  <IonThumbnail slot="start">
                    <img
                      alt="Silhouette of mountains"
                      src="/assets/images/McEarlEstolatanPic.png"
                    />
                  </IonThumbnail>
                ...
                <IonItem>
                  <IonThumbnail slot="start">
                    <img
                      alt="Silhouette of mountains"
                      src="/assets/images/AntonPatrickFontillasPic.png"
                    />
                  </IonThumbnail>
                ...
                <IonItem lines="none">
                  <IonThumbnail slot="start">
                    <img
                      alt="Silhouette of mountains"
                      src="/assets/images/LuigiUrbanoPic.png"
                    />
                  </IonThumbnail>
